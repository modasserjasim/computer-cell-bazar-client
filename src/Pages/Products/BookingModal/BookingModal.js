        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box relative bg-white">
                    ...
                    {
                        user?.uid ? <form onSubmit={handleBooking}>
                        ...
                        </form> : <h2 className='text-xl my-10 text-center'>Thanks for your interest for {title} product. Please <Link to='/login' className='text-primary'>login here</Link> to booking this product.</h2>
                    }
