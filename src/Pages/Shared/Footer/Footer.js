...
const Footer = () => {
    return (
        <footer className="text-center lg:text-left bg-base-100">
            ...
            <div className="py-10 text-center md:text-left max-w-7xl mx-auto">
                <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="">
                        <Link className='flex items-center justify-center md:justify-start gap-2' to='/'>
                        ...
                        <p>
                            Computer Cell Bazar is a classified ads website for 2nd hand computers. We help people buy and sell laptop, desktop and computer parts.
                        </p>
                    </div>
                    <div className="md:ml-16">
                        ...
                        <p className="mb-4">
                            <Link to='/category/apple-laptops'>Apple Laptops</Link>
                        </p>
                        <p className="mb-4">
                            <Link to='/category/hp-laptops'>HP Laptops</Link>
                        </p>
                        <p className="mb-4">
                            <Link to='/category/dell-laptops'>Dell Laptops</Link>
                        </p>
                        <p>
                            <Link to='/category/asus-laptops'>ASUS Laptops</Link>
                        </p>
                    </div>
                    <div className="md:ml-16">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
            ...
            <div className="text-center p-6 bg-base-200">
                <span>Copyright © 2022
                    <a className="text-gray-600 font-semibold" href="https://modasserjasim.com"> Computer Cell Bazar.</a> All Rights Reserved. </span>
            </div>
        </footer>
    );
};
